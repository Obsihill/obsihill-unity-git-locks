...
public class GitLocks : ScriptableObject
{
    ...
    private static readonly List<string> conflictWarningIgnoreList;
    ...
    private static readonly float requestTimeout = 30; // seconds
    ...
    private static readonly string[] ignoredExtensions = new[] { ".meta" };
    ...
    {
        return Unity.Plastic.Newtonsoft.Json.JsonConvert.DeserializeObject<List<GitLocksObject>>(jsonString) ?? new List<GitLocksObject>();
    }

    public static bool IsObjectAvailableToUnlock(UnityEngine.Object obj)
    {
        return IsObjectAvailableToUnlock(AssetDatabase.GetAssetPath(obj));
    }
    ...
    {
        return IsObjectAvailableToLock(AssetDatabase.GetAssetPath(obj));
    }
    ...
    public static void BuildModifiedOnServerCache()
    {
        ...
        HashSet<string> branchesToCheck = new ();
